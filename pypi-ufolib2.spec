...
Source0  : https://files.pythonhosted.org/packages/1e/e1/d20226fc36ce7df772500409879c3a856f77a07ba8a5e1629449f219a656/ufolib2-0.17.0.tar.gz
...
%prep
%setup -q -n ufolib2-0.17.0
cd %{_builddir}/ufolib2-0.17.0
pushd ..
cp -a ufolib2-0.17.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732288451
