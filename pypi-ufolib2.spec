...
Source0  : https://files.pythonhosted.org/packages/cd/95/3bec185d3712cdc0efc2cf70ec82dd275c5c4f5d505ce6ce4be996b89411/ufolib2-0.16.1.tar.gz
...
%prep
%setup -q -n ufolib2-0.16.1
cd %{_builddir}/ufolib2-0.16.1
pushd ..
cp -a ufolib2-0.16.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730394517
